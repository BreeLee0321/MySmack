...
import com.example.xmpp_library.constant.State;
...
import static com.example.xmpp_library.constant.Conf.OPENFIRE_DEBUG;
...
public class XMPPConnection extends IConnect {
    ...
    private XMPPTCPConnection createConnection(String host, int port) {
        ...
        try {
            ...
            //设置Debug
            config.setDebuggerEnabled(OPENFIRE_DEBUG);
            //设置在线状态
